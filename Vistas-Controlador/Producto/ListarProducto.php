...
if (isset($_GET["orden"])) {
    ...
    //Vaciamos la variable de sesion para que no se nos muestren los productos 
    //que ya estan mostrandose. Mirar lineas 125 a 156.
} else {
    $_SESSION['productos'] = [];
}
...
<body>
    ...
    <div>
        ...
        if (isset($_GET["orden"])) {
            ...
            //almacenamos en $_SESSION["productos"] para que si queremos ordenarlos(116)
